...
//using Microsoft.Extensions.Logging; // ✅ nécessaire pour ILogger
...
//            var mockLogger = new Mock<ILogger<GameRulesEngine>>(); // ✅ ajout du mock logger

//            var engine = new GameRulesEngine(mockCardClient.Object, mockRepo.Object, mockLogger.Object);
...
//            var mockCardClient = new Mock<ICardClient>();
//            var mockRepo = new Mock<IGameSessionRepository>();
//            var mockLogger = new Mock<ILogger<GameRulesEngine>>(); // ✅ ajout ici aussi
